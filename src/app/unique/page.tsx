...
export const readFile = async (file: File): Promise<Record<string, unknown>[]> => {
...
export const validateVulnerabilityColumns = (data: Record<string, unknown>[]): { 
  isValid: boolean; 
  foundColumns: string[]; 
...
export const findUniqueColumns = (data: Record<string, unknown>[]): string[] => {
...
export const findCommonColumns = (data1: Record<string, unknown>[], data2: Record<string, unknown>[]): string[] => {
